...
var motorCharUUID = ble.MustParse("afdd1401-dd10-4821-bc08-95e9b0360190")

var (
	device = flag.String("device", "default", "implementation of ble")
	name   = flag.String("name", "Nordic_Custom", "name of remote peripheral")
...
func main() {
	...
	fmt.Printf("Device addr: %s\n", d.(*linux.Device).Address())
	...
	if u := p.Find(ble.NewCharacteristic(motorCharUUID)); u != nil {
		fmt.Printf("Writing motor characteristic...\n")
		err := cln.WriteCharacteristic(u.(*ble.Characteristic), []byte{0x21}, false)
		chkErr(err)
	}
